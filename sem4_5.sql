...
FROM media LEFT JOIN media_types ON media.media_type_id = media_types.id;
...
UNION SELECT * FROM friend_requests
...
SELECT DISTINCT id, concat(firstname, ' ', lastname) as friends
